...
class authprofiles_Core
{
     ...
     * @param Login_Model Login record
     * @param Profile_Model Profile record
     * @param boolean Whether or not to set the login cookie
     */
    public static function login($user_name, $login, $profile, $set_cookie=TRUE)
    {
